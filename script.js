        ...
        const recommendedSubjectsByAge = {
            "3-4": ["Kathak 4+", "Chess 4+","Arts"],
            "5-6": ["Kathak 5+","Table Tennis", "Piano"],
            "7-10": ["Kathak 7+", "Western Dance and Fitness","Table Tennis", "Guitar", "Chess 7+"],
            "11+": ["Kathak", "Western Dance and Fitness", "Piano", "Table Tennis", "Chess"]
        };

        const coursesBySubject = {
            "Kathak 4+": ["Basic Kathak", "Intermediate Kathak", "Advanced Kathak"],
            "Kathak 5+": ["Basic Kathak", "Preintermediate Kathak", "Preadvance Kathak"],
            "Kathak 7+": ["Basic Kathak", "Preintermediate Kathak"],
            ...
            "Guitar": ["Basics Guitar", "Preintermediate Guitar", "Basics Preadvance Guitar"],
            "Chess 4+": ["Chess Course 1", "Chess Course 2", "Chess Course 3","Chess Course 4"],
            "Chess 7+": ["Basics Chess", "Preintermediate Chess", "Basics Preadvance Chess"]
        };
        ...
        const stagesByCourse = {
            ...
            "Basics Chess": ["Stage 1", "Stage 2","Stage 3"],
            "Preintermediate Chess": ["Stage 4", "Stage 5","Stage 6"],
            "Basics Preadvance Chess":["Stage 7", "Stage 8","Stage 9"],
            "Basics Guitar": ["Stage 1"],
            "Preintermediate Guitar": ["Stage 2", "Stage 3"],
            "Basics Preadvance Guitar":["Stage 4"],
            "Basic Kathak":["Stage 1", "Stage 2"],
            "Intermediate Kathak": ["Stage 3", "Stage 4"],
            "Preintermediate Kathak": ["Stage 3", "Stage 4","Stage 5"],
            "Advanced Kathak":["Stage 5", "Stage 6"],
        ...
        function displayCourses(subject) {
            ...
            container.innerHTML = courses.map(course => `
                <button onclick="selectButton(this, 'course', '${course}')">${course}</button>
            `).join('');
        ...
        function displayStages(course) {
            ...
            container.innerHTML = stages.map(stage => `
                <button onclick="selectButton(this, 'stage', '${stage}')">${stage}</button>
            `).join('');
            container.style.display = "flex";
        }
        ...
        function displayStageDetails(stage) {
            ...
            // Implement the detailed descriptions based on subject and stage.
         function getStageDetails(subject, stage) {
    // Implement the detailed descriptions based on subject and stage.
    if (subject === "Chess 7+" && stage === "Stage 1") {
        return `
        ...
        `;
    } else if (subject === "Chess 7+" && stage === "Stage 2") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
        ...
        `;
    } else if (subject === "Chess 7+" && stage === "Stage 3") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
...
} else if (subject === "Chess 7+" && stage === "Stage 4") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
            <li>Introduction to Chess:</li>
    ...
    `;
} else if (subject === "Chess 7+" && stage === "Stage 5") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
    ...
    `;
} else if (subject === "Chess 7+" && stage === "Stage 6") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
            <li>Intermediate Chess:</li>
    ...
    `;
} else if (subject === "Chess 7+" && stage === "Stage 7") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
            <li>Tactics:</li>
    ...
    `;
} else if (subject === "Chess 7+" && stage === "Stage 8") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
    ...
    `;
} else if (subject === "Chess 7+" && stage === "Stage 9") {
    return `
        <strong>Content to be Covered:</strong>
        <ul>
    ...
    `;
...
} else if (subject === "Guitar" && stage === "Stage 1") {
        return `
        ...
        `;
    } else if (subject === "Guitar" && stage === "Stage 2") {
        return `
            <strong>Content:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Guitar" && stage === "Stage 3") {
        return `
            <strong>Content:</strong>
            <ul>
                <li>Finger Exercises:</li>
        ...
        `;
         } else if (subject === "Guitar" && stage === "Stage 4") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
          } else if (subject === "Kathak 4+" && stage === "Stage 1") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Kathak 4+" && stage === "Stage 2") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Kathak 4+" && stage === "Stage 3") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
     ...
     } else if (subject === "Kathak 4+" && stage === "Stage 4") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 4+" && stage === "Stage 5") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 4+" && stage === "Stage 6") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
                    <li>Chakkar with Hands (5 Taps, Slow & Double)</li>
        ...
        } else if (subject === "Kathak 5+" && stage === "Stage 1") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
        ...
        } else if (subject === "Kathak 5+" && stage === "Stage 2") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 5+" && stage === "Stage 3") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if  (subject === "Kathak 5+" && stage === "Stage 4") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 5+" && stage === "Stage 5") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 5+" && stage === "Stage 6") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 5+" && stage === "Stage 7") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
        } else if (subject === "Kathak 5+" && stage === "Stage 8") {
            return `
                <strong>Content to be Covered:</strong>
                <ul>
            ...
            `;
            ...
            } else  if (subject === "Kathak 7+" && stage === "Stage 1") {
                return `
                    <strong>Content to be Covered:</strong>
                    <ul>
                        <li>Bhumi Pranam/Namaskar (Month 1, Term 1)</li>
            ...
            } else if (subject === "Kathak 7+" && stage === "Stage 2") {
                return `
                    <strong>Content to be Covered:</strong>
                    <ul>
            ...
            } else if (subject === "Kathak 7+" && stage === "Stage 3") {
                return `
                    <strong>Content to be Covered:</strong>
                    <ul>
            ...
            } else if (subject === "Kathak 7+" && stage === "Stage 4") {
                return `
                    <strong>Content to be Covered:</strong>
                    <ul>
                ...
                `;
            } else if (subject === "Kathak 7+" && stage === "Stage 5") {
                return `
                    <strong>Content to be Covered:</strong>
                    <ul>
    ...
    } else if (subject === "Chess 4+" && stage === "Stage 1") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 2") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 3") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 4") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Introduction to Chess:</li>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 5") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 6") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
                <li>Intermediate Chess:</li>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 7") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 8") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
        ...
        `;
    } else if (subject === "Chess 4+" && stage === "Stage 9") {
        return `
            <strong>Content to be Covered:</strong>
            <ul>
...
} else if (subject === "Table Tennis" && stage === "Stage 1") {
    return `
        <strong>Content:</strong>
        <ul>
            <li>Backhand Push:</li>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 2") {
    return `
        <strong>Content:</strong>
        <ul>
            <li>Forehand Push:</li>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 3") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 4") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 5") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 6") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 7") {
    return `
        <strong>Content:</strong>
        <ul>
    ...
    `;
} else if (subject === "Table Tennis" && stage === "Stage 8") {
    return `
        <strong>Content:</strong>
        <ul>
